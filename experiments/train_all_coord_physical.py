...
from models import GenCoordModel_Physical_All_Coord
...
if __name__ == '__main__':
    ...
    model_path = str(p / 'all_coord_baseline_{}.pik'.format(args.train_size))

    random.seed(args.seed)
    model = GenCoordModel_Physical_All_Coord(model_path=model_path)
